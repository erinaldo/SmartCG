...
namespace ModSII
{
    public partial class frmSiiConsultaAgrupadaCliente : frmPlantilla, IReLocalizable
    {
        public string formCode = "MISIICATE";
        public string ficheroExtension = "ate";

        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
        public struct StructGLL01_MISIICATE
        {
        ...
        public frmSiiConsultaAgrupadaCliente()
        {
            InitializeComponent();
        }
        ...
        private void frmSiiConsultaAgrupadaCliente_Load(object sender, EventArgs e)
        {
            Log.Info("INICIO SII Consulta de Facturas Informadas Agrupadas por Cliente");
        ...
        private void frmSiiConsultaAgrupadaCliente_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmSiiConsultaAgrupadaCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            Log.Info("FIN SII Consulta de Facturas Informadas Agrupadas por Cliente");
        }
        #endregion
        ...
        private void TraducirLiterales()
        {
            ...
            this.Text = this.LP.GetText("lblfrmSiiConsultaAgrupadaClienteTitulo", "Consulta de Facturas Informadas Agrupadas por Cliente");
        ...
        private void Consultar()
        {
            ...
            try
            {
                ...
                if (this.FormValid())
                {
                    ...
                    this.dsConsultaRespuesta = this.ConsultaInformacionFacturasAgrupadaCliente(this.codigoCompania, this.ejercicioCG, periodo);
        ...
        /// <summary>
        /// Invoca la consulta de las facturas enviadas a la AEAT agrupadas por cliente
        /// </summary>
        /// <param name="compania"></param>
        /// <param name="ejercicio"></param>
        /// <param name="periodo"></param>
        /// <returns></returns>
        private DataSet ConsultaInformacionFacturasAgrupadaCliente(string compania, string ejercicio, string periodo)
        {
            ...
            try
            {
                ...
                this.dsConsultaRespuesta = this.serviceSII.WSTGsii.ConsultaLRFactInformadasAgrupadasCliente(this.codigoCompania, this.ejercicioCG, periodo,
                ...
                if (this.dsConsultaRespuesta.Tables.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        this.tgGridConsulta.Visible = false;
                        this.lblNoInfo.Text = "No existen facturas agrupadas por cliente que cumplan el criterio seleccionado"; //Falta traducir
        ...
        private bool CargarValoresUltimaPeticion(string valores)
        {
            ...
            try
            {
                IntPtr pBuf = Marshal.StringToBSTR(valores.PadRight(69,' '));
                StructGLL01_MISIICATE myStruct = (StructGLL01_MISIICATE)Marshal.PtrToStructure(pBuf, typeof(StructGLL01_MISIICATE));
        ...
        private string ValoresPeticion()
        {
            ...
            try
            {
                StructGLL01_MISIICATE myStruct;
        ...
        private void GridExportarHTML()
        {
            ...
            try
            {
                string titulo = "Consulta de Facturas Informadas Agrupadas por Cliente";
                //Columnas
                ...
                string ficheroHTML = LibroUtiles.ConsultaNombreFichero("SIIConsultaAgrupadaCliente");
