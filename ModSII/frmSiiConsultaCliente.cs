...
namespace ModSII
{
    public partial class frmSiiConsultaCliente : frmPlantilla, IReLocalizable
    {
        public string formCode = "MISIICCTE";
        public string ficheroExtension = "cte";

        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
        public struct StructGLL01_MISIICCTE
        {
        ...
        private void frmSiiConsultaCliente_Load(object sender, EventArgs e)
        {
            Log.Info("INICIO SII Consulta de Facturas Informadas por Cliente");
        ...
        private void frmSiiConsultaCliente_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmSiiConsultaCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            Log.Info("FIN SII Consulta de Facturas Informadas por Cliente");
        }
        #endregion
        ...
        private void TraducirLiterales()
        {
            ...
            this.Text = this.LP.GetText("lblfrmSiiConsultaClienteTitulo", "Consulta de Facturas Informadas por Cliente");
            ...
            this.lblNIF.Text = this.LP.GetText("lblNIFCliente", "NIF Cliente");     //Falta traducir
            this.lblNombreRazon.Text = this.LP.GetText("lblNombreRazonDest", "Nombre o Razón Social Cliente");  //Falta traducir
        ...
        /// <summary>
        /// Llama a la consulta de facturas por cliente solicitada
        /// </summary>
        private void Consultar()
        {
            ...
            try
            {
                ...
                if (this.FormValid())
                {
                    ...
                    this.dsConsultaRespuesta = this.ConsultaInformacionFacturasInformadasCliente(this.codigoCompania, this.ejercicioCG, periodo);
        ...
        /// <summary>
        /// Invoca la consulta de las facturas informadas a la AEAT por cliente
        /// </summary>
        /// <param name="compania"></param>
        /// <param name="ejercicio"></param>
        /// <param name="periodo"></param>
        /// <returns></returns>
        private DataSet ConsultaInformacionFacturasInformadasCliente(string compania, string ejercicio, string periodo)
        {
            ...
            try
            {
                ...
                this.dsConsultaRespuesta = this.serviceSII.WSTGsii.ConsultaLRFactInformadasCliente(this.codigoCompania, this.ejercicioCG, periodo,
                ...
                if (this.dsConsultaRespuesta != null && this.dsConsultaRespuesta.Tables.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        this.tgGridConsulta.Visible = false;
                        this.lblNoInfo.Text = "No existen facturas informadas por cliente que cumplan el criterio seleccionado"; //Falta traducir
        ...
        private bool CargarValoresUltimaPeticion(string valores)
        {
            ...
            try
            {
                IntPtr pBuf = Marshal.StringToBSTR(valores.PadRight(134,' '));
                StructGLL01_MISIICCTE myStruct = (StructGLL01_MISIICCTE)Marshal.PtrToStructure(pBuf, typeof(StructGLL01_MISIICCTE));
        ...
        private string ValoresPeticion()
        {
            ...
            try
            {
                StructGLL01_MISIICCTE myStruct;
        ...
        private void tgGridConsulta_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1 && e.ColumnIndex > -1)
            {
                if (this.tgGridConsulta.dsDatos.Tables.Count >= 1 && e.RowIndex <= this.tgGridConsulta.dsDatos.Tables[0].Rows.Count)
                {
                    ...
                    if (columnName == "VER")
                    {
                        string clienteNif = this.tgGridConsulta.Rows[e.RowIndex].Cells["ClienteNIF"].Value.ToString();
                        ...
                        if (columnName == "VER")
                        {
                            this.ConsultaViewFacturaInformadasCliente(e.RowIndex, clienteNif, iDEmisorFactura, facturaID);
                        }
                    }
        ...
        private void tgGridConsulta_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            if (this.tgGridConsulta.Rows.Count > 0)
            {
                ...
                if (this.tgGridConsulta.dsDatos.Tables.Contains("DatosGenerales"))
                {
                    ...
                    this.CambiarColumnasEncabezadosFacturasInformadasCliente();
        ...
        /// <summary>
        /// Llama al formulario que visualiza la factura enviada informadas por cliente seleccionada
        /// </summary>
        /// <param name="indice"></param>
        /// <param name="iDEmisorFactura"></param>
        /// <param name="facturaID"></param>
        private void ConsultaViewFacturaInformadasCliente(int indice, string clienteNif, string iDEmisorFactura, FacturaIdentificador facturaID)
        {
            try
            {
                frmSiiConsultaViewFactInformadaCliente frmViewFacturaInformadaCliente = new frmSiiConsultaViewFactInformadaCliente();
                frmViewFacturaInformadaCliente.Ejercicio = this.txtEjercicio.Text;
                frmViewFacturaInformadaCliente.Periodo = this.cmbPeriodo.SelectedValue.ToString();
                frmViewFacturaInformadaCliente.FacturaID = facturaID;

                //Buscar la factura (por si se ordenó por columnas)
                string filtro = "(ClienteNIF='" + clienteNif + "') AND ";
                ...
                try
                {
                    ...
                    frmViewFacturaInformadaCliente.RowDatosGrles = rowDatosGrles;
                }
                catch (Exception ex)
                {
                    frmViewFacturaInformadaCliente.RowDatosGrles = null;
                    Log.Error(Utiles.CreateExceptionString(ex));
                }
                ...
                try
                {
                    ...
                    frmViewFacturaInformadaCliente.RowMasInfo = rowDatosMasInfo;
                }
                catch (Exception ex)
                {
                    frmViewFacturaInformadaCliente.RowMasInfo = null;
                    Log.Error(Utiles.CreateExceptionString(ex));
                }
                ...
                try
                {
                    ...
                    frmViewFacturaInformadaCliente.DtDetallesIVA = dtIVA;
                }
                catch (Exception ex)
                {
                    frmViewFacturaInformadaCliente.DtDetallesIVA = null;
                    Log.Error(Utiles.CreateExceptionString(ex));
                }

                frmViewFacturaInformadaCliente.Show(this);
            }
            catch (Exception ex) { Log.Error(Utiles.CreateExceptionString(ex)); }
        }
        ...
        private void CambiarColumnasEncabezadosFacturasInformadasCliente()
        {
            try
            {
                if (this.tgGridConsulta.dsDatos.Tables[0].Columns.Contains("ClienteNIF")) this.tgGridConsulta.CambiarColumnHeader("ClienteNIF", "NIF Cliente");  //Falta traducir
                if (this.tgGridConsulta.dsDatos.Tables[0].Columns.Contains("ClienteNombreRazonSocial")) this.tgGridConsulta.CambiarColumnHeader("ClienteNombreRazonSocial", "Nombre o Razón Social Cliente");  //Falta traducir
        ...
        private void GridExportarHTML()
        {
            ...
            try
            {
                string titulo = "Consulta de Facturas Informadas por Cliente";
                //Columnas
                ...
                string ficheroHTML = LibroUtiles.ConsultaNombreFichero("SIIConsultaCliente");
