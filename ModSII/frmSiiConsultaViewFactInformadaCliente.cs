...
namespace ModSII
{
    public partial class frmSiiConsultaViewFactInformadaCliente : frmPlantilla, IReLocalizable
    {
        ...
        public frmSiiConsultaViewFactInformadaCliente()
        {
            InitializeComponent();
        }
        ...
        private void frmSiiConsultaViewFactInformadaCliente_Load(object sender, EventArgs e)
        {
            Log.Info("INICIO SII Consulta Ver Factura Informada por Cliente");
        ...
        private void dgDF_DetalleSujetoPasivo_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            if (this.dgDF_DetalleSujetoPasivo.Rows.Count > 0) this.dgDF_DetalleSujetoPasivo.Rows[0].Selected = false;
        }

        private void frmSiiConsultaViewFactInformadaCliente_Shown(object sender, EventArgs e)
        {
            //if (true)
            if (this.agencia == "C")
            {
        ...
        private void frmSiiConsultaViewFactInformadaCliente_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmSiiConsultaViewFactInformadaCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            Log.Info("FIN SII Consulta Ver Factura Informada por Cliente");
        }
        #endregion
        ...
        {
            this.Text = this.LP.GetText("lblfrmSiiConsultaViewFactInformadaClienteTitulo", "Consulta de Factura Informada por Cliente (datos en Hacienda)");     //Falta traducir
        ...
        private void EscribirDatosCabecera()
        {
            try
            {
                ...
                {
                    this.txtClienteNIF.Text = this.rowDatosGrles["ClienteNIF"].ToString();
                    this.txtClienteNombreRazonSocial.Text = this.rowDatosGrles["ClienteNombreRazonSocial"].ToString();
        ...
        private void EscribirDatosGenerales()
        {
            try
            {
                ...
                if (this.rowMasInfo != null)
                {
                    ...
                    string factSimplificadaArticulos72_73 = this.rowMasInfo["FacturaSimplificadasArticulos72_73"].ToString().Trim();
                    ...
                    string pagos = this.rowMasInfo["Pagos"].ToString();
        ...
        private void EliminarColumnasDetallesIVA()
        {
            try
            {
                if (this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Contains("ClienteNIF")) this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Remove("ClienteNIF");
                if (this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Contains("ClienteNombreRazonSocial")) this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Remove("ClienteNombreRazonSocial");
                if (this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Contains("IDEmisorFacturaNIF")) this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Remove("IDEmisorFacturaNIF");
                if (this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Contains("IDNombreRazonSocial")) this.dgDF_DetalleIVA.dsDatos.Tables[0].Columns.Remove("IDNombreRazonSocial");
        ...
        private void EliminarColumnasDetallesIVASujetoPasivo()
        {
            try
            {
                if (this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Contains("ClienteNIF")) this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Remove("ClienteNIF");
                if (this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Contains("ClienteNombreRazonSocial")) this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Remove("ClienteNombreRazonSocial");
                if (this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Contains("IDEmisorFacturaNIF")) this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Remove("IDEmisorFacturaNIF");
                if (this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Contains("IDNombreRazonSocial")) this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Remove("IDNombreRazonSocial");
        ...
        private void CambiarColumnasEncabezadosDetallesIVASujetoPasivo()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (this.dgDF_DetalleSujetoPasivo.dsDatos.Tables[0].Columns.Contains("CuotaRecargoEquivalencia")) this.dgDF_DetalleSujetoPasivo.CambiarColumnHeader("CuotaRecargoEquivalencia", "Cuota Recargo Equivalencia");  //Falta 
                }
            }
            catch (Exception ex) { GlobalVar.Log.Error(Utiles.CreateExceptionString(ex)); }
        }
