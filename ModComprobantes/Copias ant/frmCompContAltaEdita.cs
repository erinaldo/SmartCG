...
namespace ModComprobantes
{
    public partial class frmCompContAltaEdita : frmPlantilla, IReLocalizable
    {
        ...
        {
            Log.Info("INCIO Alta / Edita comprobantes contables ");
...
//DUDA            this.tgTexBoxSelTipo.ValueChanged += new TGTexBoxSel.ValueChangedCommandEventHandler(tgTexBoxSelTipo_ValueChanged);
        ...
        private void FrmCompContAltaEdita_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            string cmbCompania = this.cmbCompania.Text.Substring(0, 2).ToString();
            string cmbTipo = this.cmbTipo.Text.Substring(0, 2).ToString();
            string cmbClase = this.cmbClase.Text.Substring(0, 1).ToString();
        ...
        private string ValidarCompania(string codigo)
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    if (!(this.edicionLoteError)) this.extendido = this.CamposExtendidos();
        ...
        private string ValidarGrabarFormulario()
        {
            ...
            result = validarCompania + validarAAPP + validarFecha + validarCuadre;
        ...
        private bool ValidarComprobanteCuadra()
        {
            ...
            try
            {
                ...
                if (!documentocuadra)
                {
                    validarCuadre = "  - " + this.LP.GetText("lblfrmCompContErrSinCuadrar", "Moneda Local Comprobante sin cuadrar") + "\n\r";
                }
                ...
                if (clase != "0")
                {
                    ...
                    if (!documentocuadra)
                    {
                        validarCuadre += "  - " + this.LP.GetText("lblfrmCompContErrSinCuadrar", "Moneda Extranjera Comprobante sin cuadrar") + "\n\r";
                    }
                }
            }
                        catch (Exception ex)
                ...
                for (int i = 0; i < this.dgDetalle.dsDatos.Tables["Detalle"].Rows.Count; i++)
                {
                    if (!TodaFilaEnBlanco(this.dgDetalle.dsDatos.Tables["Detalle"], i))
                    {
                        ...
                        if (result == "")
                        {
                            ...
                            if (rowNumber != "") this.dgDetalle.dsDatos.Tables["Detalle"].Rows[i]["RowNumber"] = rowNumber;
                        }
                    }
                }
            }
