...
namespace ModComprobantes
{
    public partial class frmCompContListaGLB01 :  frmPlantilla, IReLocalizable
    {
            ...
            try
            {
                ...
                for (int i = 0; i < this.radGridViewComprobantes.SelectedRows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (!comprobanteCuadra)
                        {
                            RadMessageBox.Show(this.LP.GetText("lblErrUserAprobCompDesc", "No es posible aprobar un Comprobante descuadrado "), this.LP.GetText("errValTitulo", "Error"));   //Falta traducir;
                            return;
                        }
        ...
        private bool ValidarComprobanteCuadra(int i, string tipo)
        {
            ...
            if (tipo == "C") accion = "Aprobar y  Contabilizar";
